BEGIN {
	...
	for (bay = 0; bay < 10000*NBAYS; bay += 10000) {
		# DEF
		if (bay % 20000) {
		...
		nodes[3] = bay + 50;
		side_add("front_top_" bay, 3, nodes, 11 + bay/10000);

		nodes[2] = "rear_def_" bay;
		nodes[1] = "rear_bej_" bay;
		nodes[3] = bay + 150;
		side_add("rear_top_" bay, 3, nodes, 11 + bay/10000);

		nodes[1] = "front_hi_" bay;
		nodes[2] = "front_fgh_" bay;
		nodes[3] = bay + 60;
		side_add("front_bottom_" bay, 3, nodes, 11 + bay/10000);

		nodes[2] = "rear_hi_" bay;
		nodes[1] = "rear_fgh_" bay;
		nodes[3] = bay + 160;
		side_add("rear_bottom_" bay, 3, nodes, 11 + bay/10000);
	}
}
