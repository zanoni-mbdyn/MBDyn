#! /usr/bin/python
#
# $Header: /var/cvs/mbdyn/mbdyn/mbdyn-1.0/tests/plates/gopal2010/gopal2010_static.py,v 1.2 2014/12/13 17:15:55 masarati Exp $
#
...
inputfile = 'gopal2010m_ext_static';

mbdyn_cmd = '/home/masarati/Lavoro/mbdyn/mbdyn-strnode-bld/mbdyn/mbdyn';
#mbdyn_cmd = 'mbdyn';
...
nodes = 462 # set to the actual count of mapped points
labels = 0;
...
while 1:
	...
	for n in range(nodes):
		...
		structure.n_f[3*n+2] = 1.e-2/nodes*cnt;
