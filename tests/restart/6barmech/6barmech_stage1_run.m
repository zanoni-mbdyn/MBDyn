...
try
  ...
  for k=1:numel(ad)
    ...
    mbdyn_solver_run("6barmech_stage1.mbd", opts);
    opts.output_file = "stage2";
    opts.logfile = "stage2.stdout";
    mbdyn_solver_run("6barmech_stage2.mbd", opts);
    ...
    fprintf(stderr, "[%d] maximum difference between stage1 and stage2: %e\n", k, max_diff);
