...
\begin{Verbatim}[commandchars=\\\{\}]
  \bnt{elem_type} ::= \{ \kw{pressureq4} | \kw{pressureq8} | \kw{pressureq8r} | \kw{pressureq9} | \kw{pressuret6} | \kw{pressuret10} \}
...
See also table~\ref{sec:EL:SURFLOAD:elemtypes} for a list of supported elements.
\begin{Verbatim}[commandchars=\\\{\}]
  \bnt{elem_type} ::= \{ \kw{tractionq4} | \kw{tractionq8} | \kw{tractionq8r} | \kw{tractionq9} | \kw{tractiont6} | \kw{tractiont10} \}
...
\begin{table}[h!tp]
  \begin{tabular}[t]{|c|c|c|c|c|c|c|}
    ...
    \hline
    \kw{pressuret10} & \kw{tractiont10} & 10 & \ref{fig:EL:SURFLOAD:TRIANGLE10} & 25 & 3 & ? \tabularnewline
    \hline
  \end{tabular}
...
\begin{figure}[htb]
  ...
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth]{triangle10}
    \caption{\kw{pressuret10}, \kw{tractiont10}}
    \label{fig:EL:SURFLOAD:TRIANGLE10}
  \end{subfigure}  
