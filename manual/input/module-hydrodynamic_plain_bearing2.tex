...
\item deformable bearing journal and bearing shell surfaces (e.g. two way fluid structure interaction)
\end{itemize}
...
\begin{Verbatim}[commandchars=\\\{\}]
    ...
    \bnt{arglist} ::=
            \kw{hydraulic fluid},
                \kw{hydraulic fluid}, (\hty{HydraulicFluid}) \bnt{hydraulic_fluid},
...
\begin{Verbatim}[commandchars=\\\{\}]
     \bnt{compliance_model} :: =
      \{ \bnt{compliance_mod_nodal} | \bnt{compliance_mod_modal} | \bnt{compliance_mod_double_nodal} \}
