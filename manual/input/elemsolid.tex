...
\begin{Verbatim}[commandchars=\\\{\}]
  \bnt{elem_type} ::= \{ \kw{hexahedron8} | \kw{hexahedron20} | \kw{hexahedron20r} | \kw{hexahedron27} |
                    \kw{pentahedron15} | \kw{pentahedron18} | \kw{tetrahedron10} | \kw{tetrahedron20}
                    ...
                    \kw{pentahedron15f} | \kw{pentahedron18f} | \kw{tetrahedron10f} | \kw{tetrahedron20f} \}
...
\begin{table}[h!tp]
  ...
  \hline
  \kw{pentahedron18} & $\surd$ & & \tabularnewline
  \hline  
  \kw{tetrahedron10} & $\surd$ & & \tabularnewline
  \hline
  \kw{tetrahedron20} & $\surd$ & & \tabularnewline
  \hline
  ...
  \hline
  \kw{pentahedron18f} & & & $\surd$ \tabularnewline
  \hline  
  \kw{tetrahedron10f} & & & $\surd$ \tabularnewline
  \hline
  \kw{tetrahedron20f} & & & $\surd$ \tabularnewline
  \hline
  \end{tabular}
...
\begin{tabular}[t]{|l|c|c|c|c|c|c|c|}
  ...
  \hline
  \kw{pentahedron18} & 18 & \ref{fig:EL:SOLID:PENTAHEDRON18} & 21 & 2 & full & \cite{CODEASTERR30301} \tabularnewline
  \hline  
  \kw{tetrahedron10} & 10 & \ref{fig:EL:SOLID:TETRAHEDRON10H} & 5 & 2 & full & \cite{CODEASTERR30301} \tabularnewline
  \hline
  \kw{tetrahedron20} & 20 & \ref{fig:EL:SOLID:TETRAHEDRON20} & 11 & 3 & full & ? \tabularnewline
  \hline
\end{tabular}
...
\begin{tabular}[t]{|l|c|c|c|c|c|c|c|c|}
  ...
  \hline
  \kw{pentahedron18f} & 18 & \ref{fig:EL:SOLID:PENTAHEDRON18} & 21 & 2 & full & \cite{CODEASTERR30301} \tabularnewline
  \hline  
  \kw{tetrahedron10f} & 10 & \ref{fig:EL:SOLID:TETRAHEDRON10H} & 5 & 2 & full & \cite{CODEASTERR30301} \tabularnewline
  \hline
  \kw{tetrahedron20f} & 20 & \ref{fig:EL:SOLID:TETRAHEDRON20} & 11 & 3 & full & ? \tabularnewline
  \hline  
\end{tabular}
...
\begin{figure}[htb]
  ...
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics[width=.5\textwidth]{tetrahedron20}
    \caption{tetrahedron20}
    \label{fig:EL:SOLID:TETRAHEDRON20}
  \end{subfigure}  
  \caption{Node order}
...
\begin{figure}[htb]
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{hexahedron27}
    \caption{Node order: hexahedron27}
    \label{fig:EL:SOLID:HEXAHEDRON27}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics[width=.5\textwidth]{pentahedron18}
    \caption{pentahedron18}
    \label{fig:EL:SOLID:PENTAHEDRON18}
  \end{subfigure}
\end{figure}
