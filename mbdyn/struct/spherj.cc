			    ...
			    const VectorHandler& XPrimeCurr )
{
   ...
   if (fc) {
    ...
    //   } else {
          ...
          dQ1.Set(Eye3/modF, 1, 1, 1);
          dQ1.SetCol(-F/(modF*modF), 1, 2, 1);
          dQ1.Link(2, &dmodF);
      // }
      ...
      // if (compute_Q) {
          ...
          dF2.SetCol(-Q.GetCol(3) * F.Norm(), 1, 3, 2);
          dF2.Link(3, &dfc);
