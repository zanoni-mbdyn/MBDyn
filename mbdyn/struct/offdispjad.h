...
#ifndef OFFDISPJOINTAD_H
#define OFFDISPJOINTAD_H
...
class OffsetDispJointAd: public Joint {
public:
     OffsetDispJointAd(unsigned int uL,
                       const DofOwner* pD,
...
private:
     ...
     void SaveReactionForce(const sp_grad::SpColVector<sp_grad::SpGradient, 3>& F1,
                            const sp_grad::SpColVector<sp_grad::SpGradient, 3>& M1) {}
     void SaveReactionForce(const sp_grad::SpColVector<sp_grad::GpGradProd, 3>& F1,
                            const sp_grad::SpColVector<sp_grad::GpGradProd, 3>& M1) {}
     const StructNodeAd* const pNode1;
     const StructDispNodeAd* const pNode2;
     const Vec3 o1;
     Vec3 F1Tmp, M1Tmp;
};
