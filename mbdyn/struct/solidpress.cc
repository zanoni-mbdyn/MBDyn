...
template <>
struct SurfaceTractionHelper<SurfaceTractionType::TRAC_RELATIVE> {
...
template <>
struct SurfaceTractionHelper<SurfaceTractionType::TRAC_ABSOLUTE> {
     template <typename T, sp_grad::index_type iNumCols, typename ElementType>
     static inline void
     AssSurfaceTraction(ElementType& oElem,
			sp_grad::SpColVector<T, iNumCols>& f,
									     ...
									     enum sp_grad::SpFunctionCall func)
{
     ...
     constexpr index_type iCapacity = iNumDof * (eType == SurfaceTractionType::TRAC_RELATIVE);
...
template SurfaceLoadElem* ReadPressureLoad<Triangle10, CollocTria10>(DataManager*, MBDynParser&, unsigned int);
...
ReadTractionLoad(DataManager* const pDM, MBDynParser& HP, const unsigned int uLabel)
{
     ...
     typedef SurfaceTraction<ElementType, CollocationType, SurfLoadFromDrives<iNumNodes>, SurfaceTractionType::TRAC_RELATIVE> SurfaceTractionRel;
     typedef SurfaceTraction<ElementType, CollocationType, SurfLoadFromDrives<iNumNodes>, SurfaceTractionType::TRAC_ABSOLUTE> SurfaceTractionAbs;

     const SurfaceTractionType eTractionType = HP.IsKeyWord("absolute") ? SurfaceTractionType::TRAC_ABSOLUTE : SurfaceTractionType::TRAC_RELATIVE;
     ...
     case SurfaceTractionType::TRAC_RELATIVE:
	  SAFENEWWITHCONSTRUCTOR(pElem,
				 SurfaceTractionRel,
				 SurfaceTractionRel(uLabel, rgNodes, std::move(oSurfLoadFromDrives), Rf, fOut));
	  break;
     case SurfaceTractionType::TRAC_ABSOLUTE:
	  SAFENEWWITHCONSTRUCTOR(pElem,
				 SurfaceTractionAbs,
...
template SurfaceLoadElem* ReadTractionLoad<Triangle10, CollocTria10>(DataManager*, MBDynParser&, unsigned int);
