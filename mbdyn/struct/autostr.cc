...
void AutomaticStructDispElem::Restart(RestartData& oData, RestartData::RestartAction eAction)
{
     oData.Sync(RestartData::ELEM_AUTOSTRUCT, GetLabel(), "B", B, eAction);
     oData.Sync(RestartData::ELEM_AUTOSTRUCT, GetLabel(), "BP", BP, eAction);
     oData.Sync(RestartData::ELEM_AUTOSTRUCT, GetLabel(), "m", m, eAction);
}
...
void AutomaticStructElem::Restart(RestartData& oData, RestartData::RestartAction eAction)
{
     AutomaticStructDispElem::Restart(oData, eAction);

     oData.Sync(RestartData::ELEM_AUTOSTRUCT, GetLabel(), "G", G, eAction);
     oData.Sync(RestartData::ELEM_AUTOSTRUCT, GetLabel(), "GP", GP, eAction);
     oData.Sync(RestartData::ELEM_AUTOSTRUCT, GetLabel(), "S", S, eAction);
     oData.Sync(RestartData::ELEM_AUTOSTRUCT, GetLabel(), "J", J, eAction);
}
