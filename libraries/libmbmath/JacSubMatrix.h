...
public:
	...
	void SetIdx(const integer i, const integer iidx);
	void Set(const doublereal xx, const integer i, const integer iidx);
	void Set(const Vec3& xx, const integer i, const integer iidx);
	doublereal& operator ()(const integer i);
	const doublereal& operator ()(const integer i) const;
	void Set(const doublereal xx, const integer i);
	void Set(const Vec3& xx, const integer i);
	void Add(const doublereal xx, const integer i);
...
public:
	...
	void SetBlockIdx(const integer block, const integer iidx);
...
// 	const doublereal& operator ()(integer i) const;
	...
	void Add(const Vec3& xx, const integer eq, const integer block, const integer block_col = 1);
	void Sub(const Vec3& xx, const integer eq, const integer block, const integer block_col = 1);
	void Add(const Mat3x3& xx, const integer eq, const integer block, const integer block_col = 1);
